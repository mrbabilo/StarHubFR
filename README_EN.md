...
*   [**Qwen**](https://ollama.com/library/qwen3.5) by the **Qwen team** (Apache-2.0) — the model family the app suggests by default, chosen for its regular sizes and multilingual ability. The choice stays yours: the Model field takes anything your server serves.
