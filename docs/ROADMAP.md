...
| **X112** | 2026-09-24 | « Vider les mods désactivés » effaçait ~720 dossiers sans retour, hors corbeille, et laissait leurs préférences : `ModTrash.trash` met le lot en un événement de corbeille, partagé avec `deleteMod` |
...
| **X109** | 2026-09-24 | « Tout activer / désactiver » vidait le profil actif si `Mods/` était illisible (disque externe éjecté) : `ProfileRecovery.adoptDiskState` refuse une lecture illisible |
| **X108** | 2026-09-24 | Snooze « jusqu'à la prochaine version de Stardew » réveillé à la première lecture du journal quand la version était inconnue ; au passage, deux silences d'écriture du report C2-T4 journalisés et la sauvegarde de config une-par-jour unifiée |
| **X107** | 2026-09-24 | Un favori ou une marque « à écarter » orphelins restaient pour toujours : purge unique dans `forgetStores`, et l'Entretien juge six magasins (`folderKeyedPreferenceKeys`). 1 orphelin sur le parc, SVE |
