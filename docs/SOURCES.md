...
| [**SDV-Radiance**](https://www.nexusmods.com/stardewvalley/mods/49397) — phuicmt, 1.7.6 | `phuicmt.SDVRadiance` · Nexus 49397 · `GitHub:PHUICMT/SDV-Radiance` · dépendance GMCM optionnelle · **installé sur le parc** | suite graphique lourde (bloom, color grading, sun shafts, ombres directionnelles, reflets) embarquant **un analyseur de performances** — suivie aux côtés d'`us_analyze` (UltraSmooth) et du `[BigLoop]` du Profiler pour l'écosystème perf |
