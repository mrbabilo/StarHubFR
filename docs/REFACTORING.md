...
>
> **Relevé d'après-tranches (2026-09-11, Nexus t2+t3+t4)** : le VM est à
> **10 413 lignes** — les catégories ont suivi (`NexusCategoryResolver`, Core,
> 10 tests ; la mémoïsation et ses invalidations restent au VM). La reprise Nexus (verdicts nommés, substitution du cache, décompte
