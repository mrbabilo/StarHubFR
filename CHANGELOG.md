...
- **Chaque section montre quatre mods, « voir plus » déplie la suite.** Le même bouton déplie d'abord ce qui est déjà en cache, puis demande la tranche suivante au serveur quand le cache est épuisé. Une barre de liens en tête de vitrine saute directement à une section, y compris quand celle du dessus a été dépliée.
