...
- **Voir plus de mods dans une section, et dans les résultats de recherche.** Chaque bande s'arrêtait à vingt mods sur des sections qui en comptent des milliers ; un bouton dans l'en-tête de la section en demande la suite et l'ajoute à ce qui est déjà là, sans doublon. Il disparaît quand tout est chargé.

- **Le filtre par catégorie s'applique aussi aux résultats de recherche**, au serveur comme pour les sections : le total annoncé et la suite chargée parlent du même ensemble que les cartes. Changer de catégorie refait la recherche en cours.
...
- **Chaque section montre quatre mods, « voir plus » en ajoute quatre.** Le même bouton déplie d'abord ce qui est déjà en cache, puis demande la tranche suivante au serveur quand le cache est épuisé — le réseau livre par vingt, l'affichage par quatre. Une barre de liens en tête de vitrine saute directement à une section, y compris quand celle du dessus a été dépliée.
- **L'onglet Découvrir redessiné.** Une seule rangée de commandes au lieu de trois — les trois boutons de rafraîchissement des sections déclenchaient tous le même rechargement. La carte occupe désormais sa case de grille, sa vignette passe en 16/9 pleine largeur (elle laissait deux marges grises), et « Installé » se pose sur l'image plutôt qu'en bas de pile. La fiche s'ouvre sur un bandeau illustré et une bande de quatre chiffres — endossements, version, âge de la mise à jour, catégorie.
...
- **Sur un compte gratuit, « Ouvrir sur Nexus » devient le bouton principal de la fiche** : l'installation directe y est refusée par l'API, autant mettre en avant le chemin qui marche.
- **Les sections s'affichent en grille.** Elles défilaient horizontalement : sur la largeur d'un écran, 4 ou 5 mods visibles sur 20, sans ascenseur pour dire qu'il y en avait d'autres — et les vingt suivants demandés par « voir plus » atterrissaient hors de vue. Tout ce qui est chargé se voit maintenant en déroulant la page.
