    ...
    targets: [
        .target(
            ...
            sources: [
                ...
                "Models/NexusDownloadFlow.swift",
                ...
                "Models/DiscoveryScoping.swift",
                "Models/DisabledModsCleanup.swift",
        ...
        .testTarget(
            name: "ChangelogExcerptTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/ChangelogExcerptTests"
        ),
        .testTarget(
        ...
        .testTarget(
            name: "ModDetailRefreshTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/ModDetailRefreshTests"
        ),
        .testTarget(
        ...
        .testTarget(
            name: "TranslationPresenceTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/TranslationPresenceTests"
        ),
        .testTarget(
        ...
        .testTarget(
            name: "ProfileActivationTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/ProfileActivationTests"
        ),
        .testTarget(
            name: "ProfileConfigCaptureTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/ProfileConfigCaptureTests"
        ),
        .testTarget(
        ...
        .testTarget(
            name: "DiscoveryScopingTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/DiscoveryScopingTests"
        ),
        .testTarget(
            name: "DisabledModsCleanupTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/DisabledModsCleanupTests"
        ),
        .testTarget(
        ...
        .testTarget(
            name: "ModUpdateSnoozerTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/ModUpdateSnoozerTests"
        ),
        .testTarget(
        ...
        .testTarget(
            name: "ModUpdateKeyDeltaStoreTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/ModUpdateKeyDeltaStoreTests"
        ),
        .testTarget(
            name: "RenameReportTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/RenameReportTests"
        ),
        .testTarget(
        ...
        .testTarget(
            ...
            dependencies: ["StarHubTHCore"],
            path: "Tests/SmapiInstallMarkerTests"
        ),
        .testTarget(
        ...
        .testTarget(
            ...
            dependencies: ["StarHubTHCore"],
            path: "Tests/ManifestlessArchiveTests"
        ),
        .testTarget(
        ...
        .testTarget(
            ...
            dependencies: ["StarHubTHCore"],
            path: "Tests/NexusModSearchTests"
        ),
        .testTarget(
            name: "NexusAccountTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/NexusAccountTests"
        ),
        .testTarget(
        ...
        .testTarget(
            ...
            dependencies: ["StarHubTHCore"],
            path: "Tests/ModListKeyStepTests"
        ),
        .testTarget(
        ...
        .testTarget(
            ...
            dependencies: ["StarHubTHCore"],
            path: "Tests/NexusAccountStoreTests"
        ),
        .testTarget(
            name: "ModUpdateStoreTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/ModUpdateStoreTests"
        ),
        .testTarget(
            name: "ProfileTranslationStoreTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/ProfileTranslationStoreTests"
        ),
        .testTarget(
            name: "TranslationHubStoreTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/TranslationHubStoreTests"
        ),
        .testTarget(
        ...
        .testTarget(
            ...
            dependencies: ["StarHubTHCore"],
            path: "Tests/DiscoveryStoreTests"
        ),
        .testTarget(
        ...
        .testTarget(
            ...
            dependencies: ["StarHubTHCore"],
            path: "Tests/SmapiHealthStoreTests"
        ),
        .testTarget(
            name: "LogStoreTests",
            dependencies: ["StarHubTHCore"],
        ...
        .testTarget(
            name: "NexusDownloadFlowTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/NexusDownloadFlowTests"
        ),
        .testTarget(
        ...
        .testTarget(
            name: "ConfigJSONDiffTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/ConfigJSONDiffTests"
        ),
        .testTarget(
        ...
        .testTarget(
            ...
            dependencies: ["StarHubTHCore"],
            path: "Tests/ProfileTranslationCoverageTests"
        ),
        .testTarget(
        ...
        .testTarget(
            name: "ProfileApplyPlanTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/ProfileApplyPlanTests"
        ),
        .testTarget(
        ...
        .testTarget(
            name: "SettingsSectionOrderTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/SettingsSectionOrderTests"
        ),
        .testTarget(
            name: "NexusArchiveStoreTests",
            dependencies: ["StarHubTHCore"],
            path: "Tests/NexusArchiveStoreTests"
        ),
        .testTarget(
