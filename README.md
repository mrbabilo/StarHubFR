...
*   [**Qwen**](https://ollama.com/library/qwen3.5) par l'**équipe Qwen** (Apache-2.0) — la famille de modèles que l'app conseille par défaut, choisie pour ses tailles régulières et ses aptitudes multilingues. Le choix reste le vôtre : le champ Modèle accepte n'importe quel modèle servi par votre serveur.
