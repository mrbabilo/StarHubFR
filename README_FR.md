> [!IMPORTANT]
> Ce fork ajoute le support de la langue française. Pour la version originale en thaï, consultez le [README thaï](README.md). Pour la version anglaise, consultez le [README anglais](README_EN.md).
